...
Follow [the instructions](https://rstudio.github.io/distill/publish_article.html#github-pages) on how to create a repository and add a Distill article. For step 4 on creating a Distill article, you can find how to do that from the [Distill website](https://rstudio.github.io/distill/basics.html#creating-an-article). To do this you will have to install the distill pacakge with:

```{r eval=FALSE}
install.packages("distill")
```

You should change the metadata on your article and write a few sentences in the main text about you might be interested in writing about. You will submit a link to the public article (not the github repository) to Canvas (not Gradescope). 
...
## Milestone 4: Add one results from one analysis (due 11/18)
...
## Final step: Write up final report
...
**This final report will be due on Monday, December 14th, 2022 at 11:59pm ET**
