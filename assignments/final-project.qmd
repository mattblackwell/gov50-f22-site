...
- Write your current thoughts in an Rmd file and submit. (10/7)
- Create a new public GitHub repository the article [Instructions](https://rstudio.github.io/distill/publish_article.html) (10/21)
- Find a data source and write a short proposal on your research question (10/28)
- Add one polished data visualization on your distill article (11/11?)
- Add results from one set of analyses (11/18)
