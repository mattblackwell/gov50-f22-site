...
1. Follow the link at the top of the problem set on the course website
   a Canvas page that has all of the Github Classroom links for each
   assignment.
...
![](/files/img/gradescope-upload.png){fig-alt="Uploading your zip file to Gradescope"}
