...
- [**Content**](/content/) ({{< fa book-open-reader >}}): This page contains the readings, slides, and recorded lectures (if any) for the topic. Read/watch these first.
...
schedule <- schedule %>%
  ...
  select(Week = week, Date = col_date, Title = col_title, Reading = col_reading, Content = col_content,
